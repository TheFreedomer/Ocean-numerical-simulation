...
time_axis_02 = np.arange(0, 10, 1.5)
...
# #
cd01 = CD01(time_axis_02, space_axis_, K_, U_)
T_ns_ = cd01.run_numerical_solution()
# draw gif
filepath_ = '../fig/hw0107_cd_1d_ftcs_ns_lamda02.gif'
cd01.draw_gif(T_ns_, 1, 100, 8, filepath_)

# #
cd02 = CD02(time_axis_02, space_axis_, K_, U_, bc_)
T_ns_ = cd02.run_numerical_solution()
# draw gif
filepath_ = '../fig/hw0107_cd_1d_btcs_ns_lamda02.gif'
